    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="row">
                        <a href="<?php echo BASE_URL ?>/operacao/declaracao_vigencia/<?php echo !empty($cooperado['cooperado']['cod_cooperado']) ? $cooperado['cooperado']['cod_cooperado'] : '' ?>" target="_blank">
                            <div class="col-xs-12">
                                <i class="fa fa-file-alt fa-3x pull-left"></i>
                                <div class="font-bold"> Declaração </div>
