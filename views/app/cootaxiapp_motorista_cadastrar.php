<div id="section-container">
    <div class="row" >
        <div class="col-sm-12 col-md-12 col-lg-12" id="pagina-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-book"></i> Cadastrar Motorista no Aplicativo</li>
            </ol>
        </div>
    </div>
    <!--FIM pagina-header-->
    <div class="row">
        ...
        <div class="col-md-12 clear">
            <form method="POST" autocomplete="off"  name="nEditarMotorista" id="form_motorista">
                <div class="panel panel-black">
                    <div class="panel-heading">
                        <p class="panel-title"><i class="fa fa-user-plus"></i> Motorista</p>
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-xs-12 <?php echo (isset($motorista_erro['email']['class'])) ? $motorista_erro['email']['class'] : ''; ?>">
                                        ...
                                        <input type="email" name="nEmail" id="iEmail" class=" form-control text-lowercase" placeholder="joab.alencar@hotmai.com" value='<?php echo isset($motorista['email']) ? $motorista['email'] : ""; ?>'/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-xs-12 <?php echo (isset($motorista_erro['senha']['class'])) ? $motorista_erro['senha']['class'] : ''; ?>">
                                        <label for="iSenha" class="control-label">Senha: * <?php echo (isset($motorista_erro['senha']['msg'])) ? '<small><span class="glyphicon glyphicon-remove"></span> ' . $motorista_erro['senha']['msg'] . ' </small>' : ''; ?></label>
                                        <input type="password" name="nSenha" id="iSenha" class=" form-control" placeholder="*********" value='<?php echo isset($motorista['senha']) ? $motorista['senha'] : ""; ?>'/>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-xs-12 <?php echo (isset($motorista_erro['repetirSenha']['class'])) ? $motorista_erro['repetirSenha']['class'] : ''; ?>">
                                        <label for="iRepetirSenha" class="control-label">Repetir Senha: * <?php echo (isset($motorista_erro['repetirSenha']['msg'])) ? '<small><span class="glyphicon glyphicon-remove"></span> ' . $motorista_erro['repetirSenha']['msg'] . ' </small>' : ''; ?></label>
                            ...
                            <div class="col-md-offset-1 col-md-5">
                                ...
                                <div class="row">
                                    <div class="form-group col-xs-12" class="control-label">
                                        ...
                                        <label><input type="radio" name="nStatus" value="ativa" checked/> Ativa</label>
